...
// Service worker template - Best practice environment-aware caching
const generateServiceWorker = (version) => `// Service Worker for smart caching - Generated at build time
...
const main = () => {
  ...
  console.log(`   - ${version === generateVersion() ? 'optcg-themer-dev-' + version : 'optcg-themer-prod-' + version}`);
  console.log(`   - ${version === generateVersion() ? 'optcg-static-dev-' + version : 'optcg-static-prod-' + version}`);
  console.log(`   - ${version === generateVersion() ? 'optcg-images-dev-' + version : 'optcg-images-prod-' + version}`);
  console.log(`   - ${version === generateVersion() ? 'optcg-api-dev-' + version : 'optcg-api-prod-' + version}`);
};
