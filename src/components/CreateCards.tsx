  ...
  return (
    <div className="h-full flex flex-col text-xl text-zinc-50">
      ...
      <div className="flex justify-center items-center w-full h-full">
        ...
        <label className="form-control max-w-full h-full flex flex-col gap-2 lg:gap-8 items-center mt-4 lg:mt-12">

          <div className="label flex flex-col gap-2 lg:gap-4 w-full">
